    ...
    <div class="view guide-view">
      ...
      <section class="guide-section">
        ...
        <ol>
          ...
          <li><b>Read the warnings first.</b> Amber boxes are rules firing: skip-rule (credit too thin), VIX floor, staggered-entry (open condor &lt; 7 days old), liquidity flags, sizing. A skip-rule warning means <i>don't trade today</i> — the tool is doing its job.</li>
          <li>No blocking warnings → read the four-leg table: <b>green rows = SELL to open, red rows = BUY to open</b>, exactly as you'll enter them.</li>
      ...
      <section class="guide-section">
        ...
        <ul>
          ...
          <li><b>Legs table:</b> strike, bid/ask, mid, |delta| (shorts should sit in your band; wing delta doesn't matter), open interest.</li>
      ...
      <section class="guide-section">
        ...
        <table class="data">
          ...
          <tbody>
            ...
            <tr><td colspan="4" class="muted">1-DTE mode fields: cadence (Thu→Fri / any-day / twice-weekly), delta band 0.06–0.12, wings 0.65%, per-side credit floor 0.025% of spot, per-side stop 3×.</td></tr>
          </tbody>
        </table>
        </div>
        <ul>
